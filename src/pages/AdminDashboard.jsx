  ...
  const fetchAll = async () => {
    ...
    try {
      const [statsRes, usersRes, productsRes, ordersRes] = await Promise.all([
        ...
        fetch(`${API_BASE_URL}/api/admin/products`, { headers: authHeaders }),
        fetch(`${API_BASE_URL}/api/admin/orders`, { headers: authHeaders }),
      ]);
  ...
  return (
    <main className="min-h-screen bg-gray-50 py-10 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        {actionMessage && (
          <div className="mb-6 p-3 rounded-lg bg-gray-900 text-white text-center text-sm">
            {actionMessage}
          </div>
        )}
        ...
        {activeTab === "Overview" && stats && (
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <StatCard
              ...
              value={formatPrice(stats.totalPlatformFees)}
              tint="#F3E4EE"
              wide
            />
          </div>
                    ...
                    <td className="p-4">
                      {u.role !== "admin" && (
                        <button
                          ...
                          className="flex items-center gap-1.5 text-red-600 hover:text-red-800 transition text-xs font-medium"
                        >
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="text-left border-b border-gray-200 bg-gray-50">
                  ...
                  <th className="p-4 font-medium text-gray-500">Vendor</th>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="text-left border-b border-gray-200 bg-gray-50">
                  ...
                  <th className="p-4 font-medium text-gray-500">Placed</th>
                </tr>
              </thead>
              <tbody>
                {orders.map((o) => (
                  ...
                  >
                    ...
                    <td className="p-4 text-gray-900">{o.buyer?.name}</td>
                    <td className="p-4 font-semibold text-gray-900">
...
function StatCard({ icon: Icon, label, value, tint, wide }) {
  return (
    <div
